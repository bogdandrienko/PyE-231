...
# 0,1 с x 1-> 0,1 с x 5 = 0,5 c
# линейная -> O(n)

# 0,1 с x 1-> 0,1 с x 5**2 = 2,5 c
# квадратичную -> O(n**2)
...
double = partial(multiply, 2)  # кэширование(запоминание) аргумента
...
result1 = calc_3(operation="/", number2=2, number1=10)      # именованный
result2 = calc_3(2, 4, "**")                                # позиционный
print(result2)
