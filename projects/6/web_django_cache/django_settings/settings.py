...
SECRET_KEY = "django-insecure-!25^w#i(urcp40156d$3x-_=qum^v_863j(v7nfjf(y5&!%fhc"
...
CACHES = {
    # из базы и рассчёт - 0.1с
    # из кэша уже рассчитанные RAM       - 0.001с (новости на главной странице)
    # из кэша уже рассчитанные Database  - 0.01с

    # массив пользователей без рассчёта(нет фильтрации, не поиска...) - 0.1с
    # массив пользователей без рассчёта Database в -> 0.1с
